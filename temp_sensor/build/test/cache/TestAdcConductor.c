...

{
  ...
  printf("Requirement ID 1001 is tested!");
...

{
    ...
    AdcModel_DoNothingExceptTestASpecialType_CMockExpectAndReturn(56, TestStruct, (1));



    do {if ((AdcConductor_JustHereToTest())) {} else {UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((UNITY_UINT)(58)));}} while(0);

 printf("Requirement ID 1002 is tested!");
...

{
    ...
    AdcModel_DoNothingExceptReturnASpecialType_CMockExpectAndReturn(90, TestStruct);



    do {if ((AdcConductor_AlsoHereToTest())) {} else {UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((UNITY_UINT)(92)));}} while(0);
...

{
    ...
    AdcModel_DoNothingExceptReturnASpecialType_CMockExpectAndReturn(101, TestStruct);



    do {if (!(AdcConductor_AlsoHereToTest())) {} else {UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((UNITY_UINT)(103)));}} while(0);
...

{
    ...
    AdModel_DoNothingExceptTestPointers_CMockExpectAndReturn(110, &TestNum, (1));



    do {if ((AdcConductor_YetAnotherTest())) {} else {UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((UNITY_UINT)(112)));}} while(0);
